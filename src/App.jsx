...
export default function App() {
  ...
  const availableCourts = Math.min(state.courtCount, Math.floor(activePlayers.length / 4));
        ...
        <div className="mx-auto flex max-w-7xl flex-col gap-4 px-4 py-5 sm:px-6 lg:flex-row lg:items-center lg:justify-between lg:px-8">
          <div>
            <div className="mb-2 inline-flex items-center gap-2 rounded-md bg-court-50 px-2 py-1 text-xs font-semibold text-court-700">
              ...
              Queue balanced doubles rotation
            </div>
            <h1 className="text-2xl font-bold tracking-tight text-slate-950 sm:text-3xl">Pickleball Court Queue</h1>
          </div>
